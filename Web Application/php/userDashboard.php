            ...
            <tr>
                <td>
                    <div class="side">
                        ...
                        <a href="mypayments.php" class="button">My Reservations</a><br>
                ...
                <td id="greeting">
                    <div id="greeting">
                        <h1>
                            <br>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Hello <?php echo $_SESSION["username"]?>
                        </h1>
                    </div>

                    <table class="box">
                        <tr class="topic">
                            <td>Upcoming Reservations:<br></td><br><br>
                        </tr>
                        <tr>&nbsp</tr>
                    ...
                    <table class="box" width="30%">
                        <tr class="topic">
                            <td>Service Update<br></td>
                        </tr>

                        <tr>
                            <td>No any updates available now</td>
                    ...
                    <table class="box" width="30%">
                        <tr class="topic" width="30%">
                            <td>Promotions & Discounts<br></td>
                        </tr>
                        <td>
                            <div class="container">
                                <u><input type="checkbox"> Discount 1 </u><br><br>
                                <u><input type="checkbox"> Discount 2 </u><br><br>
                                <u><input type="checkbox"> Discount 3 </u><br><br>
                                <u><input type="checkbox"> Discount 4 </u><br><br>
                                <u><input type="checkbox"> Discount 5 </u><br><br>
                            </div>
                        </td>
                    </table>
