...
<?php //echo $member_id;?>
    ...
    <div class="container">
        <div class="content">
            <h2>Your<br> <p>Payment</p>is Success.</h2><br><span>Click here and check your dashboard</span>
            <img src="img/Images/paysuc.png" alt="" ><br>
            <a href="userdashboard.php"><input id="btn" type="button" value="Click Here" ></a>
