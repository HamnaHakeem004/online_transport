            ...
            <tr>
                ...
                <td>
                    ...
                    <?php 
                        ...
                        $result = mysqli_query($conn,"SELECT * FROM payment WHERE memberId = '$member_id'");
                        echo "<table border='1' style='margin:auto;cellpadding:50px;border-color:black;' width='80%'>
                            <tr>
                                <th>Payment ID</th>
                                <th>Member ID</th>
                                <th>Reserve ID</th>
